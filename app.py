...
Built for IBM watsonx Orchestrate Agentic AI Hackathon
"""
...
def get_meetings():
    ...
    if not calendar_service:
        return jsonify({
            'success': False,
            'error': 'Calendar service not initialized. Check credentials.json'
        }), 500
...
def test_slack():
    ...
    success = slack_service.send_escape_notification(
        "Test notification from Priority Protector!"
    )
    return jsonify({
        'success': success,
        'message': 'Check your Slack workspace'
    })
...
if __name__ == '__main__':
    ...
    print("   AI-Powered Meeting Escape Assistant")
    print("   Powered by IBM watsonx Orchestrate")
    print("="*60)
    print("\n📍 Dashboard: http://localhost:5000")
    print("💬 Slack Bot: @Priority_Protector")
    print("🤖 IBM watsonx: Agent orchestration active")
    print("\n" + "="*60 + "\n")
